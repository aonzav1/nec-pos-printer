...
def my_write_text (txt_string, width, height,save=0):
    ...
    draw.text((0,-12),txt_string,font=font,align="left",fill=(0,0,0,255) )
...
#test_1()
#my_write_text ( "HELLOWORLD" ,416,27)
